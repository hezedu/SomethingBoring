...
hang="<ol><li>";
    ...
    }else if(MatchStr[0]==="\/" && MatchStr[1]==="*" ){
	  return "<span style='color:yellow'>"+MatchStr+"</span>";
	}
	else if(MatchStr[0]==="\/" && MatchStr[1]!=="\/" ){
	  return "<span style='color:blue'>"+MatchStr+"</span>";
	}else if(MatchStr[0]==="\/" && MatchStr[1]==="\/" ){
	  return "<span style='color:green'>"+MatchStr+"</span>";//testsetest
	}
	//testsetest
	return MatchStr;
...
.dw_zupu_fund{display:block;font-size:14px;color:#001432;}\
