...
sas.Task = function(i, t, count, parents,dis) {
  this.index = i;
  this.path = [i];
  this.count = count;
  this._dis = dis;
...
sas.Task.prototype.fspath = function() {
  var fspath_arr = [],
    path_arr = this.path;
  for (var path_i = 0, path_len = path_arr.length; path_i < path_len; path_i++) {
    if (typeof path_arr[path_i] === 'string') {
...
sas.Task.prototype.push = function(a) {
  this.count[0]++;
  this.parent[this.pIndex].push(a);
}

sas.Task.prototype.go = function(i){
  
  i = i || 1;
  this.count[1]+=i;
  this.count[1]= this.count[1] <0 ? 0 : this.count[1];
  this.count[1]= this.count[0] <this.count[1] ? this.count[0] : this.count[1];
  this._dis.next_tick(this.count[1],this._t,this.count,this.parents);
}
